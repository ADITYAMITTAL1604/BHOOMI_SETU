...
const STAGES_LIST = [
  ...
  { value: "VERIFICATION", label: "Verification & Claims" },
  { value: "NOTIFICATION", label: "Notification (Sec 11)" },
  { value: "OBJECTION", label: "Objections Hearing (Sec 15)" },
  { value: "COMPENSATION", label: "Award & Compensation" },
  { value: "REHABILITATION_RESETTLEMENT", label: "R&R Resettlement" },
  { value: "POSSESSION", label: "Possession Transfer" },
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-brand-teal-blue/10 text-brand-teal-blue border border-brand-teal-blue/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div className="relative md:col-span-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-teal-blue/30 focus:border-brand-teal-blue transition-all"
            />
          </div>
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-brand-teal-blue/30 focus:border-brand-teal-blue transition-all"
            >
              ...
              {isLoading ? (
                Array.from({ length: 8 }).map((_, i) => (
                  <tr key={i} className="animate-pulse">
                    <td className="px-5 py-4"><div className="h-4 bg-gray-200 rounded w-32 mb-1" /><div className="h-3 bg-gray-100 rounded w-24" /></td>
                    ...
                    <td className="px-4 py-4"><div className="h-6 bg-gray-200 rounded-full w-28" /></td>
                ...
                parcels.map((parcel) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Stage */}
                      <td className="px-4 py-3.5 whitespace-nowrap">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-brand-teal-blue/10 text-brand-teal-blue">
        ...
        <div className="px-5 py-3.5 bg-gray-50/60 border-t border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page <= 1}
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg border border-gray-200 bg-white text-xs font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
